...
import { Search, Download, Eye, Calendar, CheckCircle, XCircle } from "lucide-react"
...
export default function TransactionsPage() {
  ...
  const handleUpdateStatus = (transactionId: string, newStatus: string) => {
    ...
    // You could update the mockTransactions array here or refetch data
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Track all inventory movements and operations</p>
          </div>
